...
To update anyone's position on the team, go to the "team view" page, and click the player's current position (e.g. "Regular player").
You will be presented with a list of options for the player's new position on the team.</p>
<p>A change of position does not require any confirmation from the player<?php
...
Only captains and assistant captains may promote players, and nobody can promote someone to a position higher than their own.</p>
