...
<p class="warning-message">Any schedule edits must preferably be made before publishing the schedule, or else clearly communicated to all involved coaches and captains with enough notice that they can reasonably be expected to be able to reach all players on their roster.</p>
<?php
