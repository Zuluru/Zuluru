<p>As much as we hate to admit it, there are circumstances outside our control.
Sometimes, these circumstances will result in all games for a particular day being unplayable.
In ladder divisions, these games can typically just be deleted and similar matchups may be scheduled in the near future.
For round-robin divisions, and sometimes for ladders, you want to preserve the matchups and just move the games to a date in the future.
To do this, use the "reschedule" option from the division schedule.</p>
