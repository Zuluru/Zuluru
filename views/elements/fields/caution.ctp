<p>Please respect the following rules for all <?php __(Configure::read('ui.fields')); ?>. Note that some facilities also have additional restrictions listed on that <?php __(Configure::read('ui.field')); ?>'s page that must also be followed.</p>
<ul>
	<li>Garbage containers do not exist at most facilities. Do not leave any garbage behind when you leave -- even if it isn't yours. Take extra care to remove any hazardous items (i.e.: bottlecaps, glass) to avoid injury to others.</li>
