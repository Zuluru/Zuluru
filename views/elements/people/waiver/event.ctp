<?php
/**
 * This is the default waiver form text.
 * To change this text for your club, follow the directions for "themes" in README.themes,
 * copy this file to /zuluru/views/themed/xxx/elements/people/waiver/event.ctp, and edit that version instead.
 */
$name = Configure::read('organization.short_name');
?>
<p>You must agree to the following waiver in order to participate in any <?php echo $name; ?> events.</p>
<p>While the sport of ultimate is understood to be a non-contact sport, this 
...
and that injuries will not be sustained. Participants are reminded that they 
engage in the sport entirely at their own risk.</p>
<p>Given that <?php echo $name; ?> offers the sport of ultimate at varied and dispersed 
...
Captains and players are jointly responsible to examine the <?php __(Configure::read('ui.field')); ?> of play 
...
compromised by playing on what they consider an unsafe <?php __(Configure::read('ui.field')); ?>; this includes 
but is not limited to the refusal, as a team or individually, to play on a 
site they deem to be potentially hazardous.  <?php echo $name; ?> never forces participants 
to play when they are not comfortable doing so; games can easily be 
rescheduled.</p>
<p>While participating in <?php echo $name; ?> sponsored ultimate events, all players have 
...
to do so.</p>
<p>I, as a player participating in <?php echo $name; ?>'s ultimate
event, acknowledge that there is a risk of being injured while playing the game
of ultimate and that <?php echo $name; ?> does not warrant or guarantee the quality
or condition of ultimate playing <?php __(Configure::read('ui.fields')); ?> and other facilities, and, 
...
ultimate.</p>
<p>I acknowledge that <?php echo $name; ?> occasionally issues directions, orders and 
regulations for the use of playing <?php __(Configure::read('ui.fields')); ?> and other facilities, for the 
rules of play for the game of ultimate and for the conduct of members and 
others while on or about the ultimate playing <?php __(Configure::read('ui.fields')); ?> and that such 
...
issued by <?php echo $name; ?>.</p>
<p>I, in consideration of my participation in <?php echo $name; ?>'s ultimate 
events, do hereby release and forever discharge <?php echo $name; ?>, its directors,
...
ultimate and my use of any facility of <?php echo $name; ?> and, further, I do hereby agree 
to indemnify and save <?php echo $name; ?>, its directors, officers and employees harmless 
...
participation in the game of ultimate and my use of any facility of <?php echo $name; ?>.</p>
<p>I agree to play fairly and by the rules, having regard to the safety and the
enjoyment of other participants.</p>
