 ...
 * copy this file to /zuluru/views/themed/xxx/elements/people/waiver/membership.ctp, and edit that version instead.
 */
$name = Configure::read('organization.short_name');
?>
<p>You must agree to the following waiver in order to play in any <?php echo $name; ?> games.</p>
...
site they deem to be potentially hazardous.  <?php echo $name; ?> never forces its members 
to play when they are not comfortable doing so; games can easily be 
rescheduled.</p>
<p>While participating in <?php echo $name; ?> sponsored games of Ultimate, all players have 
...
to do so.</p>
<p>I, as a member of and player participating in <?php echo $name; ?>'s Ultimate
League, acknowledge that there is a risk of being injured while playing the game
...
<p>I, in consideration of my membership in <?php echo $name; ?> and my participation in 
ultimate games, do hereby release and forever discharge <?php echo $name; ?>, its directors,
