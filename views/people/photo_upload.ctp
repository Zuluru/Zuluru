...
<p>This is an OPTIONAL feature of the <?php echo $short; ?> web site.  Your photo will be available only to other members who are logged in to this site and will not otherwise by publicly visible.</p>
<p><strong>Photos must be approved by an administrator before they will be visible by anyone, including you. To be approved, photos must be of you and only you (e.g. no logos or shots of groups or your pet or your car) and must clearly show your face. Photos may not include nudity or depiction of any activity that is illegal or otherwise contrary to the Spirit of Ultimate.</strong></p>
<p><strong>By uploading a photo you indicate that you are the legal copyright holder, or have obtained permission from the copyright holder to use it for this purpose.</strong></p>
<p><strong>By uploading a photo you consent to allow the <?php echo $long; ?> (<?php echo $short; ?>) to publish this photograph as your profile picture on the <?php echo $short; ?> web site, and hereby release, waive and forever discharge the <?php echo $short; ?>, its employees, volunteers, officers and directors, and contractors, of and from all liability, injury, loss, death, claims, demands, damages, costs, expenses, actions and causes of action, whether in law or in equity, howsoever caused, arising from any actions related to the publishing of this photograph.</strong></p>
