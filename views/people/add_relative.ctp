...
<?php echo $this->element('people/search_results', array('extra_url' => array(__('Add as relative', true) => array('controller' => 'people', 'action' => 'add_relative', 'person' => $person['id'], 'return' => false, 'url_parameter' => 'relative')))); ?>
