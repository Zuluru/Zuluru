...
$config['sport'] = array(
	...
	'rating_questions' => array(
		__('Skill', true) => array(
			__('Compared to other players of the same sex as you, would you consider yourself:', true) => array(
			...
			__('How would you describe your throwing skills?', true) => array(
			...
			__('How would you rate your catching skills?', true) => array(
			...
			__('With respect to playing defense, you:', true) => array(
			...
			__('With respect to playing offense, you:', true) => array(
		...
		__('Experience', true) => array(

			__('For how many years have you been playing Ultimate?', true) => array(
				0 => __('0 years', true),
				1 => __('1-2 years', true),
				2 => __('3-5 years', true),
				3 => __('6-8 years', true),
			...
			__('What is the highest level at which you regularly play?', true) => array(
			...
			__('Over the past few summers, how many nights during the week did you play Ultimate? (Organized practices and regular pick-up count.)', true) => array(
			...
			__('Over the past few years, when did you normally play Ultimate?', true) => array(
			...
			__('If there was a disagreement on the field about a certain play, the majority of the time you would be able to:', true) => array(
