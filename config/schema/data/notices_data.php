...
class NoticesData {
	...
	public $records = array(
		...
		array(
			'display_to' => 'captain',
			'repeat' => null,
			'notice' => '<h2>Did you know?</h2><p>Zuluru can do attendance tracking! Edit your team (look for the <%icon edit_24.png %> icon) to turn this popular feature on. You can also customize which emails will be sent to you and your players, and when.</p>',
			'active' => 1,
			'effective_date' => '2011-10-27 00:00:00',
			'created' => '2011-10-27 00:00:00',
		),
		...
		array(
			'display_to' => 'player',
			'repeat' => null,
			'notice' => '<h2>Did you know?</h2><p>You can change your preferences for how dates and times are displayed in Zuluru. Don\'t like 24 hour military-style times? Change it in <%link people preferences My Profile -> Preferences %>!</p>',
			'active' => 1,
			'effective_date' => '2011-10-27 00:00:00',
			'created' => '2011-10-27 00:00:00',
		),
		array(
			'display_to' => 'player',
			'repeat' => null,
			'notice' => '<h2>Did you know?</h2><p>Zuluru has online help. Click the <%icon help_24.png %> icon anywhere to get a popup window with help about that item.</p>',
			'active' => 1,
			'effective_date' => '2011-10-27 00:00:00',
			'created' => '2011-10-27 00:00:00',
		),
		array(
			'display_to' => 'player',
			'repeat' => null,
			'notice' => '<h2>Did you know?</h2><p>It\'s easier than ever to find what you\'re looking for. When you hover your mouse over player and team names, popups appear with handy links to the most commonly requested pages, saving you valuable clicks.</p>',
			'active' => 1,
			'effective_date' => '2011-10-27 00:00:00',
			'created' => '2011-10-27 00:00:00',
		),
		...
		array(
			'display_to' => 'player',
			'repeat' => 'annual',
			'notice' => '<h2>Double-check your details</h2><p>Please take a moment to confirm your contact information below. <%setting organization.short_name %> and your captains use this information to communicate with you, so it\'s important that it is correct. To make any changes, go to <%link people edit My Profile -> Edit %>. If everything is correct, there is no action required.</p><p><%person first_name %> <%person last_name %><br />Email: <%person email %><br />Home phone: <%person home_phone %><br />Work phone: <%person work_phone %> <%person work_ext %><br />Mobile phone: <%person mobile_phone %>',
			'active' => 1,
			'effective_date' => '2011-10-27 00:00:00',
			'created' => '2011-10-27 00:00:00',
		),
